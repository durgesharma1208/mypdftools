  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pb-28 pt-6 sm:px-6 sm:pt-8 lg:pb-14">
      ...
      <header className="mt-5 flex flex-col gap-4 border-b border-line pb-6 sm:flex-row sm:items-start sm:gap-5">
        ...
        <Link
          to="/tools"
          className="inline-flex shrink-0 items-center gap-1.5 self-start rounded-md border border-line bg-surface px-3 py-2 text-sm font-medium text-ink-muted transition-colors hover:border-line-strong hover:text-ink"
        >
