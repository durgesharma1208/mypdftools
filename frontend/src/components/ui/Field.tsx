...
export function LogoField({
  ...
  return (
    <FieldShell label={param.label} hint={param.description}>
      <button
        type="button"
        disabled={disabled}
        onClick={() => ref.current?.click()}
        className={cn(
          'flex w-full items-center justify-center gap-2 rounded-md border border-dashed border-line py-2.5 text-sm text-ink-muted transition-colors hover:border-line-strong hover:bg-surface-muted',
